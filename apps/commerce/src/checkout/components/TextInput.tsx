...
export interface ITextInputProps<TName extends string> extends AllHTMLAttributes<HTMLInputElement> {
	name: TName;
	label: string;
}

export const TextInput = <TName extends string>(props: ITextInputProps<TName>) => (
...
export const TextInputComponent = <TName extends string>({
	...
	required,
	...props
}: ITextInputProps<TName> & FieldProps) => {
